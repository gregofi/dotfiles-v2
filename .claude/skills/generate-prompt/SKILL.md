...
description: Generate a prompt for implementing previously planned feature
disable-model-invocation: true
---

We are implementing a feature previously planned via a skill.
There must be an `PLAN.md`.
If not, do not continue and tell me the file is missing.

Read the `PLAN.md`, and plan last step which is not marked as completed.

Draft a detailed, step-by-step blueprint for building that step.
